...
class MicrowaveSRSSG(Base, MicrowaveInterface):
    ...
    def on_deactivate(self):
        ...
        self.soc.close()
        print("on deactivate", self.error())
        return
    ...
    def get_power(self):
        ...
        """
        power = float(self._ask('AMPR?'))
        print("get power", power, self.error())
        return power
    ...
    def set_list(self, frequency=None, power=None):
        ...
        print("set_list", frequency, power, self.error())
    ...
    def reset_listpos(self):
        ...
        self._write('LSTR')
        print("reset_listpos", self.error())
        return 0
    ...
    def set_sweep(self, start, stop, step, power):
        ...
        self.log.error('This was never tested!')
        print("set_sweep", start, stop, step, power, self.error())
    ...
    def reset_sweeppos(self):
        ...
        self._internal_mode = 'sweep'
        self.log.error('This was never tested!')
        print("reset_sweeppos", self.error())
    ...
    def set_ext_trigger(self, pol, timing):
        ...
        print("set_ext_trigger", self.error())
        return pol, timing
    ...
    def _ask(self, question):
        ...
        print("_ask",question, self.error())
        return message
    ...
    def _write(self, command, wait=True):
        ...
        print("write", command,  self.error())
        return statuscode
    ...
    def set_power(self, power=0.):
        ...
        print("set_power",power, self.error())
        return 0
    ...
    def set_frequency(self, freq=0.):
        ...
        print("set_frequency",freq, self.error())
        return 0
